        ...
        <div class="flex justify-between items-center p-6 border-b">
                ...
                <div class="p-6">
                    <form id="addUserForm" class="space-y-6" novalidate>
                        ...
                        <button type="submit" class="inline-flex w-full justify-center rounded-md bg-blue-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-500 sm:ml-3 sm:w-auto">
                            Add categories
                        </button>
                    </form>
                </div>
