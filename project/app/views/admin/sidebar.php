  ...
  <div class="w-64 h-screen bg-white border-r border-gray-200 fixed left-0 top-0 shadow-sm">
        ...
        <nav class="px-4 py-4">
            <ul class="space-y-2">
                <!-- Dashboard -->
                <li>
                    <a href="admin" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 rounded-lg transition-colors duration-200 group">
                ...
                <li>
                    <a href="categories" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 rounded-lg transition-colors duration-200 group">
                ...
                <li>
                    <a href="accommodation" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 rounded-lg transition-colors duration-200 group">
                ...
                <li>
                    <a href="conflits" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 rounded-lg transition-colors duration-200 group">
                ...
                <!-- Modération des avis -->
                <li>
                    <a href="avis" class="flex items-center px-4 py-3 text-gray-700 hover:bg-red-50 rounded-lg transition-colors duration-200 group">
